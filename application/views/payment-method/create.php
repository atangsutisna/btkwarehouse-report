    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 col-12">
            <div class="box box-danger">
                ...
                <form role="form" method="post" id="form-payment_method" class="form-horizontal">   
                    <?= form_hidden('category_id', isset($payment_method) ? $payment_method->category_id : NULL) ?>
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4 col-sm-4">
                                <input type="text" 
                                    name="name" 
                                    class="form-control"
                                    value="<?= set_value('name', isset($payment_method) ? $payment_method->name : NULL) ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-4 col-sm-4">
                                <textarea type="text" name="description" rows="3" 
                                    class="form-control"><?= isset($payment_method) ? $payment_method->description : NULL ?></textarea>
                            </div>
                        </div>                        
                        <div class="form-group">
