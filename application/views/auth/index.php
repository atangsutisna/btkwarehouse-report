...
<head>
  ...
  <title>Warehouse App | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <img src="<?= base_url('assets/img/btktype.png') ?>" width="70"/>
    <a href="<?php //echo site_url() ?>">Warehouse</a>
  </div>
  <!-- /.login-logo -->
    ...
    <form action="<?= site_url('auth/login') ?>" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="identity" 
          placeholder="Username/email" value="admin@admin.com" required>
